...
function experiment_configurations()
    ...
    # ------- Symplectic Double Base [[15,3,5]] - [5,5,5] ---------

    # configs["sd_5_5_5"] = (
    #     sd15_3_5(),
    #     [5,5,5],
    #     GeneticParameters(10000, 2500, 100, 0.85, 5, 0.5, 1, [1e4, 1, 10, 5e2], "jaccard"),
    #     MCTSParameters(30, [1e6,1,5,4e4], 0.99,"jaccard", true, 2, 5e4, 5.0)
    # )
    ...
    configs["sd_15_15"] = (
        SymplecticDouble(),
        [15,15],
        GeneticParameters(50000, 2000, 120, 0.85, 5, 0.5, 1, [1e5, 1, 10, 2e3], "jaccard"), 
        MCTSParameters(30, [1e6,1,5,4e4], 0.99,"jaccard", true, 2, 5e4, 5.0)
    )
    ...
    configs["color_15_16"] = (
        ...
        MCTSParameters(90, [1e6,1,5,1e4], 0.99,"jaccard", true, 2, 5e4, 5.0)
    )
