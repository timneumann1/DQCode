...
function experiment_configurations()
    ...
    genetic_params["steane_4_3"] = GeneticParameters(7500, 1500, 100, 0.85, 5, 0.5, 1, [1e4, 1, 10, 1e2], "jaccard")
    ...
    genetic_params["shor_3_3_3"] = GeneticParameters(7500, 1500, 100, 0.85, 5, 0.5, 1, [1e4, 1, 10, 1e2], "jaccard")
    ...
    genetic_params["trivariate_3_3_3_3"] = GeneticParameters(25000, 1000, 100, 0.85, 5, 0.5, 1, [1e4, 1, 10, 5e2], "jaccard")
    ...
    genetic_params["trivariate_4_4_4"] = GeneticParameters(25000, 2500, 100, 0.85, 5, 0.5, 1, [1e4, 1, 10, 5e2], "jaccard")
    ...
    genetic_params["bivariate_3_3_3_3_3_3"] = GeneticParameters(15000, 5000, 100, 0.85, 5, 0.5, 1, [3e4, 1, 10, 1e3], "jaccard")
    ...
    genetic_params["bivariate_6_6_6"] = GeneticParameters(15000, 5000, 100, 0.85, 5, 0.5, 1, [4e4, 1, 10, 1e3], "jaccard")
    ...
    genetic_params["bivariate_9_9"] = GeneticParameters(15000, 5000, 100, 0.85, 5, 0.5, 1, [5e4, 1, 10, 1e3], "jaccard")
